...
export class CreateQuizTables1784128666773 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "game" ("id" SERIAL NOT NULL, "status" "public"."status_game" NOT NULL DEFAULT 'PendingSecondPlayer', "finishAt" TIMESTAMP, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
